...
mag = MagicCell(115, -180, 360, 0)

mag.metal1.append(Rect(-20, -167, 70, 40)) # -
mag.metal1.append(Rect(-3, -127, 53, 6))

mag.metal1.append(Rect(-20, 97, 40, 40))   # +
mag.metal1.append(Rect(-3, 86, 23, 11))
...
mag.poly.append(Rect(173, -139, 15, 125))
...
mag.poly.append(Rect(273, -139, 15, 125))
...
mag.poly.append(Rect(225, -15, 15, 124))
mag.pmos.append(Rect(225, 0, 15, mag.pmos_h))    # B
